...
PROBLEM = SHELL + """
<div class="wrap">
  <span class="eyebrow">Seoul · May 2026</span>
  <h1>A drama apologised on air,<br>and muted a scene already broadcast.</h1>
  <div class="rule"></div>
  <p>Viewers had caught the historical errors the production missed.</p>
